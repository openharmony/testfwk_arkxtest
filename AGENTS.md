...
- **许可证头**：所有源码文件必须包含 Apache 2.0 许可证头 `Copyright (c) <year> Huawei Device Co., Ltd.` 后跟完整许可证文本。`<year>` 按文件实际引入年份填写——jsunit 动态树（`src/`）为 2021、静态树（`src_static/`）为 2025；uitest 为 2021-2023；testserver 为 2024；testhelper 为 2026；perftest 为 2025。
