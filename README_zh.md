...
单元测试框架以har包形式发布至[OpenHarmony组件库](https://ohpm.openharmony.cn/#cn/detail/@ohos%2Fhypium)，开发者安装Deveco Studio后，可在应用中配置依赖，以利用框架功能。测试项目构建与测试脚本执行参考[集成开发环境(IDE)使用文档](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides-V5/ide-instrument-test-V5)。
## Ui测试框架功能特性
