...
单元测试框架以har包形式发布至[OpenHarmony组件库](https://ohpm.openharmony.cn/#/cn/detail/@ohos%2Fhypium)，开发者下载Deveco Studio后，可在应用项目中配置依赖，以利用框架功能。测试项目构建与测试脚本执行，请参考[集成开发环境(IDE)使用文档](https://developer.harmonyos.com/cn/docs/documentation/doc-guides/ohos-openharmony-test-framework-0000001263160453)。
## Ui测试框架功能特性
