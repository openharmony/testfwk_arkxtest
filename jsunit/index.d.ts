...
export function beforeItSpecified(
  testCaseNames: Array<string> | string,
  callback: Function
): void;

export function afterItSpecified(
  testCaseNames: Array<string> | string,
  callback: Function
): void;
...
export class Hypium {
  ...
  static hypiumWorkerTest(
    abilityDelegator: Object,
    abilityDelegatorArguments: Object,
    testsuite: Function,
    workerPort: Object
  ): void;
  static hypiumInitWorkers(
    abilityDelegator: Object,
    scriptURL: string,
    workerNum: number,
    params: Object
...
export declare function xit(
  testCaseName: string,
  attribute: TestType | Size | Level,
  func: Function
): void;
