...
#ifndef APP_START_TIME_COLLECTION_H
#define APP_START_TIME_COLLECTION_H
...
namespace OHOS::perftest {
    ...
    private:
        shared_ptr<TimeListener> appStartListener_;
        inline static bool isCollecting_ = false;
        inline static double responseTime_ = INVALID_VALUE;
        inline static double completeTime_ = INVALID_VALUE;
    };
} // namespace OHOS::perftest
