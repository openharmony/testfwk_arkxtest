...
namespace OHOS::uitest {
    ...
    static const std::map<std::pair<WindowAction, WindowMode>, Operational> operationalMap {
        ...
        {std::pair(SPLIT, SPLIT_PRIMARY), {false, INDEX_ONE, "SPLIT_PRIMARY can not split"}},
        {std::pair(SPLIT, SPLIT_SECONDARY), {false, INDEX_ONE, "SPLIT_SECONDARY can not split"}},
        ...
        {std::pair(MAXIMIZE, SPLIT_SECONDARY), {true, INDEX_TWO, "SPLIT_SECONDARY window can not maximize"}},
        ...
        {std::pair(RESUME, SPLIT_SECONDARY), {true, INDEX_TWO, "SPLIT_SECONDARY window can not resume"}},
        ...
        {std::pair(MINIMIZE, SPLIT_SECONDARY), {true, INDEX_THREE, "SPLIT_SECONDARY window can not minimize"}},
        ...
        {std::pair(CLOSE, SPLIT_SECONDARY), {true, INDEX_FOUR, "SPLIT_SECONDARY window can not close"}},
