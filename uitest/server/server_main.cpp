...
namespace OHOS::uitest {
    ...
    "  dircFling  <direction> [velocity] [stepLength] [displayId]    direction ranges from 0,1,2,3 (left, right, up, down)\n"
    "  click/doubleClick/longClick <x> <y> [displayId]                           click on the target coordinates\n"
    "  swipe/drag <from_x> <from_y> <to_x> <to_y> [velocity] [displayId]  velocity ranges from 200 to 40000, default 600\n"
    "  fling <from_x> <from_y> <to_x> <to_y> [velocity] [stepLength] [displayId]   velocity ranges from 200 to 40000, default 600\n"
